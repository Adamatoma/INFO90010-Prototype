...
class GuidelineLb extends React.Component {
  constructor(props) {
    super(props);
  ...
  callAPI() {
    fetch("http://localhost:3000/guideline/lb")
      .then(res => res.json())
      ...
      <>
        ...
        <div className="container">
          <div className="address">
            <div style={{ fontSize: '9px', color: '#7f7f7f' }}>Home > Guidelines > Lease break</div>
          </div>

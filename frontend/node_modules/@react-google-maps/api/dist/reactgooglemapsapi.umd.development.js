(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('invariant'), require('@googlemaps/js-api-loader'), require('@react-google-maps/marker-clusterer'), require('react-dom'), require('@react-google-maps/infobox')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'invariant', '@googlemaps/js-api-loader', '@react-google-maps/marker-clusterer', 'react-dom', '@react-google-maps/infobox'], factory) :
  (global = global || self, factory(global.reactGoogleMapsApi = {}, global.React, global.invariant, global.jsApiLoader, global.markerClusterer, global.ReactDOM, global.infobox));
}(this, (function (exports, React, invariant, jsApiLoader, markerClusterer, ReactDOM, infobox) { 'use strict';
